        ...
        sss = "<style>*{margin:0;padding:0;outline:0}#containers{position:absolute;width:100%!important;height:100%!important}*:focus{outline:0}</style><section id='wrap'><div class='youtube-theme video-fill' style='object-fit:fill cover;'><video autoplay='true' autostart='true' data-shaka-player='' poster='https://cdn.jsdelivr.net/gh/minozotv/soku@main/rakets.jpg' id='youtube-theme' style='width: 100vw; height: calc(var(--vh, 1vh) * 100);'></video></div></section><div class='shaka-range-container shaka-volume-bar-container' style='background:linear-gradient(to right,#ffffff 100%,rgba(255,255,255,0.54) 100%,rgba(255,255,255,0.54) 100%)'></div><div class='shaka-range-container shaka-seek-bar-container' style='background:rgba(255,255,255,0.3)'>\x3cscript>const manifestUri=\x27" + alif + "\x27;async function init(){const video=document.getElementById(\x27youtube-theme\x27);const ui=video[\x27ui\x27];const controls=ui.getControls();const player=controls.getPlayer();const config={\x27controlPanelElements\x27:[\x27play_pause\x27,\x27time_and_duration\x27,\x27mute\x27,\x27volume\x27,\x27spacer\x27,\x27captions\x27,\x27language\x27,\x27quality\x27,\x27fullscreen\x27]};";
